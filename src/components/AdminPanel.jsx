  ...
  const downloadExcel = (type) => {
    const filtered = entries
      ...
      .map((e) => ({
        SubAdmin: e.subAdmin || "",
        College:
    e.entryType === "Inter" ? e.collegeName || "" : "",
        ...
        <div className="overflow-x-auto rounded-xl border border-white/10">
          <table className="min-w-[1000px] w-full border-collapse text-sm whitespace-nowrap">
            <thead className="bg-gradient-to-r from-gray-800 to-gray-900">
              <tr>
                <th className="border p-3 text-xs uppercase tracking-wide">Entry By</th>
                <th className="border p-3 text-xs uppercase tracking-wide">Player</th>
                <th className="border p-3 text-xs uppercase tracking-wide">Phone</th>
                <th className="border p-3 text-xs uppercase tracking-wide">Gender</th>
                <th className="border p-3 text-xs uppercase tracking-wide">Email</th>
                ...
                <th className="border p-3 text-xs uppercase tracking-wide">Sport</th>
                <th className="border p-3 text-xs uppercase tracking-wide">Category</th>
                <th className="border p-3 text-xs uppercase tracking-wide">Department</th>
                <th className="border p-3 text-xs uppercase tracking-wide">Amount</th>
                <th className="border p-3 text-xs uppercase tracking-wide">Action</th>
              </tr>
            </thead>
              ...
              {entries
                ...
                .map((e) => (
                  ...
                  >
                    ...
                    <td className="border p-3 font-medium">{e.playerName}</td>
